function [ accu_F_U,accu_F_T ] = Func_Risk( X_L,Y_L,X_U,Y_U,X_T,Y_T,Number_Iter )
          ...
          % Hx_exp=0;
           ...
           for j=1:C
              ...
              % 考虑对X_train中未标注数据的条件熵
                 Hx_exp_j_train=calculateRisk(F_train_plus_nom);
               % 考虑对X_test中未标注数据的条件熵 
 %                F_test_plus=evaluate_testSet_new( W_test_train,Y_train,F_train_plus_nom, Set_train_L);
 %               Hx_exp_j_test=calculateRisk(F_test_plus);
